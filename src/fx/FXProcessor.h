...
public:
    ...
    void processStepFX(PatternPlayState& state, const Pattern& pattern, int step, double bpm);
...
private:
    ...
    void handleSlide(PatternPlayState& state, const Pattern& pattern, int currentStep, double bpm);
